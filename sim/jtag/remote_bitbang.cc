// from https://github.com/chipsalliance/rocket-chip/blob/master/src/main/resources/csrc/remote_bitbang.cc
  ...
  err(0)
{
  ...
  fprintf(stderr, "This emulator compiled with JTAG Remote Bitbang client.\n");
